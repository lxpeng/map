...
public class PointQuadTree<T extends PointQuadTree.Item> {
    ...
    /**
     * @param item Remove the given item from the set.
    ...
    /**
     * @param searchBounds Search for all items within a given bounds.
     * @return Search for all items within a given bounds.
     */
