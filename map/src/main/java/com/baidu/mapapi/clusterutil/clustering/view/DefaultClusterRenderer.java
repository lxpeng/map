...
public class DefaultClusterRenderer<T extends ClusterItem> implements
    ...
    /**
     * @param cluster Gets the "bucket" for a particular cluster. By default, uses the number of points within the
    ...
    /**
     * @param cluster Determine whether the cluster should be rendered as individual markers or a cluster.
     * @return boolean
     */
