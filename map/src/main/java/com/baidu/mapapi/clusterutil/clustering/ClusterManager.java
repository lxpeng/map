...
public class ClusterManager<T extends ClusterItem> implements
    ...
    /**
     * @param listener Sets a callback that's invoked when a Cluster is tapped. Note: For this listener to function,
    ...
    /**
     * @param listener Sets a callback that's invoked when an individual ClusterItem is tapped. Note: For this
    ...
    /**
     * @param listener Sets a callback that's invoked when an individual ClusterItem's Info Window is tapped. Note: For this
    ...
    /**
     *
     * @param <T> Called when a Cluster is clicked.
     */
